...
public class TransferenciaDaoImpl implements TransferenciaDao {
	...
	public void generaRegistroPagoConcentrado(
		...
		if (domingoElectronico.getProgramacion().equals("SEMANAL")) {
			...
			monthly_day = Integer.valueOf(TimeUtils.getDateFormat(fechaFinal.toDate(), "dd"));

		}
		
		// mexicanada 15-12-2015
		if( tipoProgramacion == 0){
			// si es mensual en la columna MONTHLY_DAY de la tabla DC_PROGCONCEN se guarda el dia de inicio
			Date fechaInicioProgramacion = TimeUtils.getDate( domingoElectronico.getInicioProgramacion() + " " + domingoElectronico.getHoraProgramacion(), "dd/MMMM/yyyy HH:mm");
			DateTime fechaInicial = new DateTime(fechaInicioProgramacion);
			monthly_hh = TimeUtils.getDateFormat(fechaFinal.toDate(), "HH");
			monthly_ss = TimeUtils.getDateFormat(fechaFinal.toDate(), "mm");
			monthly_day = Integer.valueOf(TimeUtils.getDateFormat( fechaInicial.toDate(), "dd"));
		}
		...
		db2Dao.getJdbcTemplate().update(
				...
				new Object[] {
						...
						tipoProgramacion,
						domingoElectronico.getDay1_hh(),
						domingoElectronico.getDay1_ss(),
						domingoElectronico.getDay2_hh(),
						domingoElectronico.getDay2_ss(),						
						domingoElectronico.getDay3_hh(),
						domingoElectronico.getDay3_ss(),						
						domingoElectronico.getDay4_hh(),
						domingoElectronico.getDay4_ss(),						
						domingoElectronico.getDay5_hh(),
						domingoElectronico.getDay5_ss(),						
						domingoElectronico.getDay6_hh(),
						domingoElectronico.getDay6_ss(),
						domingoElectronico.getDay7_hh(),
						domingoElectronico.getDay7_ss(),
