...
@Component
@Scope("prototype")
public class TransferenciaBonusService extends Transferencia {

	@Autowired
	@Resource(name = "transferenciaBonusServiceImpl")
	TransferenciaAfirmeNet service;

	@Autowired
	protected ValidacionEspecificaTransferenciaService validacionEspecifica;

	TransferenciaBonusService() {
		super(TipoTransferencia.TRASPASO_PUNTOS_BONUS);
	}
	...
	public List<TipoValidacion> getValidaciones() {
		TipoValidacion valida[] = new TipoValidacion[] { TipoValidacion.FECHA,
				TipoValidacion.HORARIO };
