...
public class TransferenciaPropiasServiceImpl implements TransferenciaAfirmeNet {
	static final AfirmeNetLog LOG = new AfirmeNetLog(TransferenciaPropiasServiceImpl.class);
	...
	public ComprobanteTransferencia ejecutaTransferencia(
        ...
        try {
			...
			afitrans.setINTXPMTV(transferenciaBase.getTransactionCode());
...
//					System.out.println("ComprobanteTransferencia: "+tx.getContractId()+" "+tx.getDestino().getNumber());
