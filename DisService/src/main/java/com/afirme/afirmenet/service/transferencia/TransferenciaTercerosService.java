...
public class TransferenciaTercerosService extends Transferencia {
	...
	public List<TipoValidacion> getValidaciones() {
		TipoValidacion valida[]=new TipoValidacion[]{TipoValidacion.FECHA_SIN_HOLIDAY,TipoValidacion.HORARIO,TipoValidacion.LIMITE_DIARIO,TipoValidacion.LIMITE_MENSUAL}; 
