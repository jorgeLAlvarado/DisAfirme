...
@Component
@Scope("prototype")
public class CreditoNominaService extends Transferencia {

	@Autowired
	@Resource(name = "creditoNominaServiceImpl")
	TransferenciaAfirmeNet service;
	
	protected CreditoNominaService(TipoTransferencia tipoTransferencia) {
		super(TipoTransferencia.NOMINA);
	}
