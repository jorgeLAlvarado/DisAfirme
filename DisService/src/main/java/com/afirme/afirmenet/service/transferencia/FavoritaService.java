...
public interface FavoritaService {
	...
	/**
	 * Metodo que guarda el nuevo orden de favoritas
	 * 
	 * @param miTransaccionFavorita
	 */
	public void insertaTransaccionFavorita(Favorita miTransaccionFavorita);

	
	/**
	 * Metodo que elimina las favoritas para el nuevo orden de favoritas
	 * 
	 * @param contrato
	 */
	...
	/**
	 * Metodo que elimina la transaccion favorita seleccionada
	 * 
	 * @param contrato
	 */
