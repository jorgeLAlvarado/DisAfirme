package com.afirme.afirmenet.empresas.daoImpl.administrador.usuarios;
...
public class UsuariosDaoImpl implements UsuariosDao{
	...
	/* (non-Javadoc)
	 * @see com.afirme.afirmenet.empresas.dao.administrador.Emp_TokensDisponiblesDao#getNumToken()
	 */
