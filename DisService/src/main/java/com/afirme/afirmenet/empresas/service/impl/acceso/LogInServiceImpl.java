...
public class LogInServiceImpl implements LogInService {
	...
	public boolean verificaINOUT(String UserIdJSP) {
		...
		if (inout.equals("")) {
			...
			String ultimaActiv = logDao.getLTime(UserIdJSP);
			// Si no encontro datos entonces toma un default
	...
	public JBLogin getUserLogin(String UserIdJSP, String UserPassJSP) throws AfirmeNetException {
		...
		Socket socket;
			...
			LOG.setSendInfo("consultaL", "01", "0", UserIdJSP, UserIdJSP, "", "", "", password.getFormatName());
			password.send();
			password.destroy();

			MessageRecord newMessage = messageContext.receiveMessage();
			LOG.setGetInfo("consultaL", "01", "0", UserIdJSP, "", "", "", "", newMessage);
			...
			LOG.setLogInfo(UserIdJSP, "", "El sistema excedio el tiempo de respuesta", "");
	...
	public ContrasenaDTO actualizaContrasena(ContrasenaDTO contrasenaDTO) throws AfirmeNetException {
		...
		try{
			...
			// prepara mensaje con nuevos parámetros
			PWDDSJVMessage password = (PWDDSJVMessage) messageContext.getMessageRecord("PWDDSJV");
			
			password.setPWDUSR(contrasenaDTO.getContrato());
			password.setPWDPWD(contrasenaDTO.getContrasenaActual());
			password.setPWDNPW(contrasenaDTO.getContrasenaNueva());
			password.setPWDNCH("");
			password.setPWDSTS("");
			LOG.setSendInfo("modifica", "01", "0", contrasenaDTO.getContrato(), "", "", "", "", password.getFormatName());
			password.send();
			password.destroy();
			
			MessageRecord newMessage = messageContext.receiveMessage();
			LOG.setGetInfo("modifica", "01", "0", contrasenaDTO.getContrato(), "", "", "", "", newMessage);
			contrasenaDTO.setStatus400( ((PWDDSJVMessage) newMessage).getPWDSTS().trim() );
			contrasenaDTO.setErrorNumS400( ((PWDDSJVMessage) newMessage).getPWDNCH().trim() );
	 ...
	 * @throws Exception
	 * 
	 * @see com.afirme.afirmenet.service.acceso.LogInService#guardarRegistroEnDCCONFMSG(com.afirme.afirmenet.service.acceso.DC_CONFMSG)
	 */
	@Override
	public boolean guardarRegistroEnDCCONFMSG(DC_CONFMSG confmsgdatabean) throws Exception {
		return loginDao.guardarRegistroEnDCCONFMSG(confmsgdatabean);
	}
	 ...
	 * @throws Exception
	 * 
	 * @see com.afirme.afirmenet.service.acceso.LogInService#guardarRegistroEnDCLOG(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String)
	 *
	 */
	@Override
	public boolean guardarRegistroEnDCLOG( 
		...
		return loginDao.guardarRegistroEnDCLOG(dttm, entityID, userID, laction, remark, account, amount, currency, typTran, dcibsREF);
	}
