...
public class Divisa extends TransferenciaBase {
	...
	private BigDecimal divisaCompra = new BigDecimal(0);
	private BigDecimal divisaVenta = new BigDecimal(0);
	...
	private BigDecimal tipoCambio = new BigDecimal(0);
	private BigDecimal montoUSD = new BigDecimal(0);
	private BigDecimal montoConversion = new BigDecimal(0);
	...
	private BigDecimal commisionConversion = new BigDecimal(0);
	private BigDecimal taxCommisionConversion = new BigDecimal(0);
	private String claveTasaPreferencial; // Clave para Tasa Preferencial en Dolares
	
	// Necesarios para borrar cuentas swift
	private Timestamp fechaBorradoTS;
	private String nombreTipoOperacion;
	private String estatus;
	private String codigoSWIFToCodigoABA;
	private String tipoSWIFT;
	...
	/**
	 * @return the claveTasaPreferencial
	 */
	public String getClaveTasaPreferencial() {
		return claveTasaPreferencial;
	}
	/**
	 * @param claveTasaPreferencial the claveTasaPreferencial to set
	 */
	public void setClaveTasaPreferencial(String claveTasaPreferencial) {
		this.claveTasaPreferencial = claveTasaPreferencial;
	}
	
	public Timestamp getFechaBorradoTS() {
		return fechaBorradoTS;
	}
	public void setFechaBorradoTS(Timestamp fechaBorradoTS) {
		this.fechaBorradoTS = fechaBorradoTS;
	}
	...
	public String getCodigoSWIFToCodigoABA() {
		return codigoSWIFToCodigoABA;
	}
	public void setCodigoSWIFToCodigoABA(String codigoSWIFToCodigoABA) {
		this.codigoSWIFToCodigoABA = codigoSWIFToCodigoABA;
	}
