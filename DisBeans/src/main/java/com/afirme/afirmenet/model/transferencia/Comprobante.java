...
public class Comprobante extends TransferenciaBase implements
	...
	public Comprobante(TransferenciaBase base) {
		...
		setAccion(base.getAccion());
		setConvenio(base.getConvenio());
		setType(base.getType());
		setTransaccionDescrip(base.getTransaccionDescrip());
		setServiceType(base.getServiceType());
		setInterType(base.getInterType());
        setAfirmeNetReference(base.getAfirmeNetReference());
        setSts(base.getValidationHour().equals("00")?"Exitoso":"Pendiente");
	}
