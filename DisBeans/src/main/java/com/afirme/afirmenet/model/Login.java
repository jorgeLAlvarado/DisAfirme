...
public class Login {
	...
	/**
	 * @return el intentosToken
	 */
	public int getIntentosToken() {
		return intentosToken;
	}

	/**
	 * @param intentosToken el intentosToken a establecer
	 */
	public void setIntentosToken(int intentosToken) {
		this.intentosToken = intentosToken;
	}
