...
public class GlobalExceptionController {
	...
	public ModelAndView handleCustomException(
		...
		LOG.error("********Error al generar una conexión por Socket********",
	...
	public ModelAndView handleHttpSessionRequiredException(HttpSessionRequiredException exception) {
		...
		model.addObject("errMsg",
				"Se genero un error al tratar de enviar su petición en más de 1 ocasión, le sugerimos revisar los movimientos efectuados");
	...
	public ModelAndView handleCustomException(
		...
		model.addObject("titleError", "Por el momento AfirmeNet no puede procesar su petición");
		return model;
	...
	public ModelAndView handleSessionExpiredException(
		...
		ModelAndView model = new ModelAndView("base/error/genericError");
		model.addObject("errMsg", "La sesión expiró, ingrese nuevamente");
		model.addObject("titleError", "Por el momento AfirmeNet no puede procesar su petición");
		return model;
	...
	/**
	 * Metodo para redireccionar en caso que se realice un Request a un mapping cuyo método (GET/POST)
	 * no es soportado
	 * @param exception
	 * @return
	 */
	...
	public ModelAndView handleMethodNotSupportedException(HttpRequestMethodNotSupportedException exception, HttpServletRequest request) {
		LOG.info("********Error controlado: Se efectúo un Request(GET/POST) a un mapping que no soporta tal método. Se realiza Redireccionamiento********");
