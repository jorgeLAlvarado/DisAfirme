 ...
 * 
 * Modificado on Sep 20, 2015 7:40:35 PM by eguzher
 * <br>
 * <br>
...
public class AfirmeNetMail {
	...
	private String mailTemplateStr;
	private String contentType;
	// private Map<String,String> velocityAttributes = new HashMap<String, String>();
	private Map<String,Object> velocityAttributes = new HashMap<String, Object>();
	...
	public String getMailTemplateStr() {
		return mailTemplateStr;
	}

	public void setMailTemplateStr(String mailTemplateStr) {
		this.mailTemplateStr = mailTemplateStr;
	}

	public Map<String, Object> getVelocityAttributes() {
		return velocityAttributes;
	}

	public void setVelocityAttributes(Map<String, Object> velocityAttributes) {
